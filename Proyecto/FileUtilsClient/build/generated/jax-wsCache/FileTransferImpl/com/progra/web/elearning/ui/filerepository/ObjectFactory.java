 ...
 * generated in the com.progra.web.elearning.ui.filerepository package. 
...
public class ObjectFactory {
    ...
    private final static QName _Upload_QNAME = new QName("http://fileRepository.ui.elearning.web.progra.com/", "upload");
    private final static QName _DownloadResponse_QNAME = new QName("http://fileRepository.ui.elearning.web.progra.com/", "downloadResponse");
    private final static QName _UploadResponse_QNAME = new QName("http://fileRepository.ui.elearning.web.progra.com/", "uploadResponse");
    private final static QName _Download_QNAME = new QName("http://fileRepository.ui.elearning.web.progra.com/", "download");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.progra.web.elearning.ui.filerepository
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://fileRepository.ui.elearning.web.progra.com/", name = "upload")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://fileRepository.ui.elearning.web.progra.com/", name = "downloadResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://fileRepository.ui.elearning.web.progra.com/", name = "uploadResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://fileRepository.ui.elearning.web.progra.com/", name = "download")
